<?php
/**
 * Client side accounting management
 *
 ...
 */
class ClientAccountingImpl extends Accounting {
    ...
    protected function getConfig() {
        $cartoclient = Cartoclient::getInstance();
        return $cartoclient->getConfig();
    }
}
