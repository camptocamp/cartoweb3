...
public class IncrementalGridCenterTest extends DbTestCase {
    public IncrementalGridCenterTest(String name) {
        super(name);
    }
    ...
    public void testBasic() throws SQLException, ClassNotFoundException {
        ...
        checkGridValue(0, 1, 1, "count");
        checkGridValue(0, 1, 2, "count");
        checkGridValue(0, 1, 3, "count");
        checkGridValue(0, 3, 1, "count");
        checkGridValue(0, 3, 2, "count");
        checkGridValue(0, 3, 3, "count");
        checkGridValue(0, 2, 1, "count");
        checkGridValue(0, 2, 3, "count");
    ...
    protected Report createReport() {
        ...
        Filter[] filters = {};
        Classifier<?> classifier = new GridClassifier(0, 50, 10, 0, 50, 10, false, RESULT_TABLE, TIME_SCALES);
        Result[] results = {
