...
<a href="javascript:void(0);" onclick="javascript:checkChildren('layersroot'); CartoWeb.trigger('Layers.LayerShowHide');">{t}check all{/t}</a> -
<a href="javascript:void(0);" onclick="javascript:checkChildren('layersroot', false); CartoWeb.trigger('Layers.LayerShowHide');">{t}uncheck all{/t}</a></div>
<div id="layersroot">
