...
<table ><tr><td><input type="text" id="outline_label_text" name="outline_label_text" value="your label" onFocus="this.value = ''"><input type="submit" value="ok" style="margin:1px" onClick="javascript:dhtmlBox.submitForm()">
</td></tr></table></div>