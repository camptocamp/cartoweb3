  ...
  <div id="loadbarDiv" class="dhtmldiv" style="position:absolute;z-index:3;">
    <table style="width:{$mainmap_width}px;height:{$mainmap_height}px;">
      <tr>
        ...
        <img src="{r type=gfx/layout}loadingbar.gif{/r}" width="32" height="32" alt="" /></div></td>
      </tr>
    </table>
  </div>
{if $collapsibleKeymap|default:''}
  <div id="keymapContainer">
    <div id="floatkeymap">
      ...
      onclick="//{literal}AjaxHandler.doAction('mapPanByKeymap', {clickedElement:this});return false;{/literal}" />
    </div>
