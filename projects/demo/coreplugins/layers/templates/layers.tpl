...
<!--
<div id="layerscmd">
  <a href="javascript:expandAll('layersroot');"><img src="{r type=gfx/layout}expand_tree.png{/r}" alt="{t}expand tree{/t}" title="{t}expand tree{/t}"/></a>&nbsp;&nbsp;
  <a href="javascript:closeAll('layersroot');"><img src="{r type=gfx/layout}close_tree.png{/r}" alt="{t}close tree{/t}" title="{t}close tree{/t}"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:checkChildren('layersroot');"><img src="{r type=gfx/layout}check_all.png{/r}" alt="{t}check all{/t}" title="{t}check all{/t}" /></a>&nbsp;
  <a href="javascript:checkChildren('layersroot',false);"><img src="{r type=gfx/layout}uncheck_all.png{/r}" alt="{t}uncheck all{/t}" title="{t}uncheck all{/t}"/></a>
</div>
-->
<div id="layersroot">
...
{if $element.isDropDown}
  ...
  onchange="
  	AjaxHandler.doAction('Layers.layerDropDownChange');">
...
<center>
<input type="submit" class="form_button" value="{t}Refresh{/t}" />
</center>
