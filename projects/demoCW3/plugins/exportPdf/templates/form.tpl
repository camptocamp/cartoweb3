...
{if $pdfTitle}<div id="pdf_title"><fieldset><legend>{t}Title{/t}</legend><input type="text" class="input_text" name="pdfTitle" value="" /></fieldset></div>{/if}

{if $pdfNote}<div id="pdf_note"><fieldset><legend>{t}Note{/t}</legend><input type="text" class="input_text" name="pdfNote" value="" /></fieldset></div>{/if}
