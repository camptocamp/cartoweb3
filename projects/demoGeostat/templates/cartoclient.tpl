...
<head>
  <title>{t}Geostatistical tools for Cartoweb{/t}</title>
...
<div id="banner"><h1>{t}Geostatistical tools for Cartoweb{/t}</h1></div>
  ...
  <div id="leftbar">    
    ...
    <div>
      ...
      <ul class="tabnav" id="tabnav1">
        ...
        {if $geostat|default:''}<li id="label8"><a href="javascript:ontop(8)">{t}Geostat{/t}</a></li>{/if}
      </ul>
    </div>
    <div id="container">
