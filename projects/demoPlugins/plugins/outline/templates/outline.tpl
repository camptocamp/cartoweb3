...
<p style="text-align:center"><label><input type="radio" name="outline_mask" value="no"{if $outline_mask_selected eq "no"} checked="checked"{/if} />{t}Draw{/t}</label>&nbsp;&nbsp;&nbsp;
...
<p class="mini"><center><input type="submit" name="outline_clear" value="{t}Clear outline{/t}" class="form_button" /></center></p>
</div>
